...
let colors = {
  ...
  // 'brand-lightest': '#E7F5FA',
  // 'brand-lighter': '#9FD7E9',
  // 'brand-light': '#56B8D9',
  // 'brand': '#0E9AC8',
  // 'brand-dark': '#0D8BB4',
  // 'brand-darker': '#085C78',
  // 'brand-darkest': '#042E3C',

  'brand-lightest': '#FEF0ED',
  'brand-lighter': '#F9C1B6',
  'brand-light': '#F59380',
  'brand': '#F06449',
  'brand-dark': '#D85A42',
  'brand-darker': '#903C2C',
  'brand-darkest': '#481E16',
...
module.exports = {
  ...
  */
  ...
  shadows: {
    ...
    'button-hover': '0 7px 17px 0 rgba(50, 50, 93, .1), 0 3px 6px 0 rgba(0, 0, 0, .1)',
